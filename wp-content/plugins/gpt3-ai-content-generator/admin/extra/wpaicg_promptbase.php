...
<div class="wrap fs-section">
    <h2 class="nav-tab-wrapper">
        <a href="javascript:void(0)" class="nav-tab nav-tab-active">PromptBase</a>
    </h2>
    <div id="poststuff">
        <div id="fs_account">
                        ...
                        <div class="wpaicg-grid-three wpaicg-prompt-items">
                            ...
                            ?>
                                <div
                                    ...
                                    class="wpaicg-prompt-item wpaicg-d-flex wpaicg-align-items-center <?php echo implode(' ',$wpaicg_item_categories)?><?php echo ' user-'.esc_html($wpaicg_item['author'])?><?php echo $wpaicg_item['type'] == 'custom' ? ' wpaicg-prompt-item-custom-'.esc_html($wpaicg_item['id']) : '';?>">
