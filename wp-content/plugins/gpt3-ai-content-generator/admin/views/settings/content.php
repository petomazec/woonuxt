...
?>
                <option disabled> -- PREMIUM FEATURES -- </option>
                <option value="curio" disabled>Curious</option>
                <option value="disap" disabled>Disappointed</option>
                <option value="encou" disabled>Encouraging</option>
                <option value="optim" disabled>Optimistic</option>
                <option value="surpr" disabled>Surprised</option>
                <option value="worry" disabled>Worried</option>
                <?php 
?>
        </select>
