...
<div id="help_tabs-1">
  <div id="accordion">
    <h3>Models</h3>
        <div>
            <p>GPT AI Power exclusively supports <mark class="wpcgai_container_help_mark">OpenAI GPT-3 models</mark>.</p>
            <p>Our plugin is designed to work with the following models:</p>
            <table class="wpcgai_container_help_table">
                ...
                <tr>
                    ...
                    <td>Most capable one. Higher quality, longer output, better instruction-following.</td>
                    <td>4,000</td>
            ...
            <p><b>Note:</b> Currently, GPT AI Power is configured to use a maximum of <b>1400 tokens per request</b>. However, we are working to increase this limit to 4000 tokens per request.</p>
            <p>OpenAI recommends using Davinci while experimenting since it will yield the best results.</p>
            <table class="wpcgai_container_help_table">
                <tr>
                    <th>Model</th>
                    <th>Good at</th>
    ...
    <h3>Parameters</h3>
        <div>
            <p>All the values that are set in the <b>AI Engine</b> tab are used as parameters for the OpenAI API. 
            These parameters will be used as the default values for single and auto content generation provided by the plugin.</p>
