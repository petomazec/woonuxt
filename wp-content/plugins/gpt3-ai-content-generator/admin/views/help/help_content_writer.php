...
<div id="help_tabs-2">
  <div id="accordion2">
    <h3>Language, Style and Tone</h3>
        <div>
          <p>GPT AI Power supports 38 languages:</p>
          <p>Arabic, Bulgarian, Chinese, Croatian, Czech, Danish, Dutch, English, Estonian, Filipino, Finnish, French, German, Greek, Hebrew, Hindi, Hungarian, Indonesian, Italian, Japanese,
    ...
    <h3>Image</h3>
        <div>
          <p>You can add images to your content using OpenAI’s DALL-E model.</p>
          <p>Here's how to use this feature:</p>
          <p><b>Adding an Image</b></p>
          <p>Before generating the content, select the “Add Image” option.</p>
          ...
          <p>You can enable this by selecting the “Set Featured Image” option in the Settings → Image tab.</p>
