...
<div id="help_tabs-10">
  ...
  <h3>Designing Your Own Prompts</h3>
        <div>
          ...
          <p><b>Model:</b> Optional - Select a GPT model for your prompt. You can choose from a variety of models, including Davinci, Curie, Ada and Babbage. If you don't select a model, the default model will be used which is currently set to Davinci.</p>
