<?php
    $relate_count = ogami_get_config('number_blog_releated', 2);
    $relate_columns = ogami_get_config('releated_blog_columns', 2);
...
<div class="related-posts">
    <h4 class="title">
        <span><?php esc_html_e( 'Related Posts', 'ogami' ); ?></span>
    </h4>
