...
$columns = ogami_get_config('dokan_product_columns');
get_header();
                ...
                <div id="dokan-content" class="store-page-wrap woocommerce site-content" role="main">
                    ...
                    <div id="dokan-content" class="store-page-wrap woocommerce" role="main">
                            ...
                            <div id="apus-shop-products-wrapper" class="apus-shop-products-wrapper">
                                ...
                                <?php woocommerce_product_loop_start(); ?>
                                        <?php while ( have_posts() ) : the_post(); ?>
                                            ...
                                            <?php wc_get_template( 'content-product.php' , array( 'columns' => $columns ) ); ?>
                        ...
                        <?php } else { ?>
                            ...
                            <p class="dokan-info"><?php esc_html_e( 'No products were found of this vendor!', 'ogami' ); ?></p>
                            ...
                            if ( ! dynamic_sidebar( 'sidebar-store' ) ) {
                                ...
                                if ( class_exists( 'Dokan_Store_Location' ) ) {
                                    ...
                                    if ( dokan_get_option( 'store_open_close', 'dokan_general', 'on' ) == 'on' ) {
                                        the_widget( 'Dokan_Store_Open_Close', array( 'title' => esc_html__( 'Store Time', 'ogami' ) ), $args );
                                    }
