...
get_header();
$sidebar_configs = ogami_get_dokan_layout_configs();

?>

<?php do_action( 'ogami_woo_template_main_before' ); ?>

<section id="main-container" class="main-container <?php echo apply_filters('ogami_dokan_content_class', 'container');?>">
                    ...
                    <div id="dokan-content" class="store-review-wrap woocommerce" role="main">
                        ...
                        <div id="reviews">
                            <div id="comments">
                                ...
                                <h2 class="headline"><?php esc_html_e( 'Seller Review', 'ogami' ); ?></h2>

                                <ol class="commentlist">
                                    <?php
                                    if ( count( $comments ) == 0 ) {
                                        echo '<span colspan="5">' . esc_html__( 'No Results Found', 'ogami' ) . '</span>';
                                    } else {
                                                            ...
                                                            <a href="<?php echo esc_url($permalink); ?>">
                                                                ...
                                                                if ( get_option('woocommerce_enable_review_rating') == 'yes' ) :
                                                                    ...
                                                                    <div class="dokan-rating">
                                                                        <div class="star-rating" title="<?php echo sprintf(__( 'Rated %d out of 5', 'ogami' ), $rating) ?>">
                                                                            <span style="width:<?php echo ( intval( get_comment_meta( $single_comment->comment_ID, 'rating', true ) ) / 5 ) * 100; ?>%"><strong><?php echo trim($rating); ?></strong> <?php esc_html_e( 'out of 5', 'ogami' ); ?></span>
                                                                        </div>
                                                                    </div>
                                                                <?php endif; ?>
                                                            </a>
                        ...
                        <div class="dokan-widget-area widget-collapse">
                            ...
                            if ( ! dynamic_sidebar( 'sidebar-store' ) ) {
                                ...
                                if ( class_exists( 'Dokan_Store_Location' ) ) {
                                    the_widget( 'Dokan_Store_Category_Menu', array( 'title' => esc_html__( 'Store Category', 'ogami' ) ), $args );

                                    if ( dokan_get_option( 'store_map', 'dokan_general', 'on' ) == 'on'  && !empty( $map_location ) ) {
                                        the_widget( 'Dokan_Store_Location', array( 'title' => esc_html__( 'Store Location', 'ogami' ) ), $args );
                                    }

                                    if ( dokan_get_option( 'contact_seller', 'dokan_general', 'on' ) == 'on' ) {
                                        the_widget( 'Dokan_Store_Contact_Form', array( 'title' => esc_html__( 'Contact Vendor', 'ogami' ) ), $args );
                                    }
                                }
