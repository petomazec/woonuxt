...
class Ogami_Elementor_Instagram extends Widget_Base {

	public function get_name() {
        return 'ogami_instagram';
    }

	public function get_title() {
        return esc_html__( 'Apus Instagram', 'ogami' );
    }
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Instagram', 'ogami' ),
        ...
        $this->add_control(
            'username',
            [
                'label' => esc_html__( 'Instagram Username', 'ogami' ),
                'type' => Controls_Manager::TEXT,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'description' => esc_html__( 'Number images to display', 'ogami' ),
                'default' => 4
            ]
        );
        ...
        $this->add_control(
            'size',
            [
                'label' => esc_html__( 'Photo size', 'ogami' ),
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    'thumbnail' => esc_html__('Thumbnail', 'ogami'),
                    'small' => esc_html__('Small', 'ogami'),
                    'large' => esc_html__('Large', 'ogami'),
                    'original' => esc_html__('Original', 'ogami'),
                ),
                'default' => 'thumbnail'
            ]
        );
        ...
        $this->add_control(
            'target',
            [
                'label' => esc_html__( 'Open links in', 'ogami' ),
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    '_self' => esc_html__('Current window (_self)', 'ogami'),
                    '_blank' => esc_html__('New window (_blank)', 'ogami'),
                ),
                'default' => 'grid'
            ]
        );
                ...
                <?php
                    ...
                    if ( $username != '' ) {
                        ...
                        if ( is_wp_error( $media_array ) ) {
                            ...
                            if ( $images_only = apply_filters( 'ogami_instagram_element_images_only', false ) ) {
...
Plugin::instance()->widgets_manager->register_widget_type( new Ogami_Elementor_Instagram );