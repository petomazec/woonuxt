...
class Ogami_Elementor_Features_Box extends Widget_Base {

	public function get_name() {
        return 'ogami_features_box';
    }

	public function get_title() {
        return esc_html__( 'Apus Features Box', 'ogami' );
    }
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'content_section',
            [
                'label' => esc_html__( 'Features Box', 'ogami' ),
        ...
        $repeater->add_control(
            'image_icon',
            [
                'label' => esc_html__( 'Image or Icon', 'ogami' ),
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    'icon' => esc_html__('Icon', 'ogami'),
                    'image' => esc_html__('Image', 'ogami'),
                ),
                'default' => 'image'
            ]
        );
        ...
        $repeater->add_control(
            'title_text',
            [
                'label' => esc_html__( 'Title & Description', 'ogami' ),
                'type' => Controls_Manager::TEXT,
                'default' => esc_html__( 'This is the heading', 'ogami' ),
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'ogami' ),
                'placeholder' => esc_html__( 'Enter your description', 'ogami' ),
                'separator' => 'none',
                'rows' => 10,
                'show_label' => false,
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => array(
                    'style1' => esc_html__('Style 1 (Shadow)', 'ogami'),
                    'style2' => esc_html__('Style 2 (Horizontal)', 'ogami'),
                    'style3' => esc_html__('Style 3 (Border)', 'ogami'),
                    'style4' => esc_html__('Style 4 (Border 2)', 'ogami'),
                ),
                'default' => 'style1'
            ]
        );
...
Plugin::instance()->widgets_manager->register_widget_type( new Ogami_Elementor_Features_Box );