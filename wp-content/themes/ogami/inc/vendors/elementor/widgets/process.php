...
class Ogami_Elementor_Process extends Widget_Base {

	public function get_name() {
        return 'ogami_process';
    }

	public function get_title() {
        return esc_html__( 'Apus Process', 'ogami' );
    }
	...
	protected function _register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                'name' => 'image',
                'label' => esc_html__( 'Icon Image', 'ogami' ),
                'type' => Controls_Manager::MEDIA,
                'placeholder'   => esc_html__( 'Upload Icon Image', 'ogami' ),
            ]
        );
        ...
        $repeater->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'input_type' => 'url',
                'placeholder' => esc_html__( 'Enter your proces link here', 'ogami' ),
            ]
        );
        ...
        $this->add_control(
            'process',
            [
                'label' => esc_html__( 'Process', 'ogami' ),
                'type' => Controls_Manager::REPEATER,
                'placeholder' => esc_html__( 'Enter your Process here', 'ogami' ),
        ...
        $this->add_control(
            ...
            [
                'name' => 'image_line',
                'label' => esc_html__( 'Background Image Space Columns', 'ogami' ),
                'type' => Controls_Manager::MEDIA,
...
Plugin::instance()->widgets_manager->register_widget_type( new Ogami_Elementor_Process );