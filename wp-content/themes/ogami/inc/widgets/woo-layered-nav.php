...
class Ogami_Widget_Woo_Layered_Nav extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = esc_html__( 'Display a list of attributes to filter products in your store.', 'ogami' );
		$this->widget_id          = 'apus_woocommerce_layered_nav';
		$this->widget_name        = esc_html__( 'Apus Filter Products by Attribute', 'ogami' );
		parent::__construct();
	}
	...
	public function init_settings() {
		...
		$this->settings = array(
			...
			'attribute' => array(
				'type'    => 'select',
				'std'     => '',
				'label'   => esc_html__( 'Attribute', 'ogami' ),
				'options' => $attribute_array,
			),
			'query_type' => array(
				'type'    => 'select',
				'std'     => 'and',
				'label'   => esc_html__( 'Query type', 'ogami' ),
				'options' => array(
					'and' => esc_html__( 'AND', 'ogami' ),
					'or'  => esc_html__( 'OR', 'ogami' ),
				),
			),
		);
	}
...
if ( function_exists('apus_framework_reg_widget') ) {
	apus_framework_reg_widget('Ogami_Widget_Woo_Layered_Nav');
}